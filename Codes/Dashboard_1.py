...
def create_options(Ab_NYC_CLEANED):
...
df = pd.read_csv("C:/Users/Syed Muneeb/Desktop/AD DS/Project/New York City Airbnb Open Data/Ab_NYC__CLEANED.csv")
df.dropna(inplace = True)
df.head()

app.layout = html.Div(children=[

    html.H1(children='Airbnb Visualizations Dashboard',  style={'color':'darkcyan', 'textAlign':'center'}),
    html.Div(children='''
        Select a plot:
    '''),
